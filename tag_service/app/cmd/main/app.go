...
import (
	...
	"path/filepath"
	"syscall"
	"tag_service/internal/config"
	"tag_service/internal/tag"
	"tag_service/internal/tag/db"
	"tag_service/pkg/handlers/metric"
	"tag_service/pkg/logging"
	mongo "tag_service/pkg/mongodb"
	"tag_service/pkg/shutdown"
	"time"
)
